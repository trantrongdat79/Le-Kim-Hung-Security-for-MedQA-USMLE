"""Run a small Sprint 3 evaluation for the LangGraph RAG workflow."""
...
from src.agent.langgraph_rag_agent import LangGraphRAGAgent
from src.core.dataset import load_medqa_split


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Evaluate the Sprint 3 LangGraph RAG workflow on MedQA."
    )
    parser.add_argument(
        "--split",
        choices=["train", "test"],
...
def main() -> None:
    ...
    agent = LangGraphRAGAgent(top_k=args.top_k)
    ...
    print()
    print("Sprint 3 LangGraph RAG Workflow Evaluation")
